...
class VideoListScreen: UIViewController {
    ...
    func creatArray()->[Video]{
        ...
        var tempVideos:[Video] = [
            Video(image: UIImage(named: "future")!, title: "Seed to the future"),Video(image: UIImage(named: "scenery")!, title: "Top 10 Places to visit now"),
            Video(image: UIImage(named: "blackpanther")!, title: "Superhero movies to die for"),Video(image: UIImage(named: "traveler")!, title: "Solo travel, the new booming industry"),Video(image: UIImage(named: "networking")!, title: "Your UPI app is a genius"),Video(image: UIImage(named: "milkyway")!, title: "The limits of space"),
            Video(image: UIImage(named: "walkway")!, title: "Escaping into the unknown"),Video(image: UIImage(named: "interstellar")!, title: "A celestial expedition"),
            Video(image: UIImage(named: "windingroad")!, title: "journey"),Video(image: UIImage(named: "smallworld")!, title: "the bulk of creation unleashed"),
            Video(image: UIImage(named: "mountains")!, title: "Where the heart is"),Video(image: UIImage(named: "mountains")!, title: "Where the heart is"),
            Video(image: UIImage(named: "trance")!, title: "To another world")
        ]
